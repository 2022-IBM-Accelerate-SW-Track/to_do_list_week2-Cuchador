...
class Home extends Component {
  ...
  addTodo = (todo) => {
    ...
    //validate todo item to make sure it does not already exist
    if (this.state.todos.find(element => element.content === todo.content)) { return; } //don't add if it already exists
